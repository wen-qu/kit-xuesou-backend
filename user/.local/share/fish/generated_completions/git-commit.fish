# git-commit
# Autogenerated from man page /usr/share/man/man1/git-commit.1
...
complete -c git-commit -s s -l signoff -l no-signoff --description 'Add a Signed-off-by trailer by the committer at the end of the commit log mes…'
