...
complete -c git-push -l force-if-includes --description 'Force an update only if the tip of the remote-tracking ref has been integrate…'
...
complete -c git-push -l no-force-if-includes --description 'disables this behavior.'
