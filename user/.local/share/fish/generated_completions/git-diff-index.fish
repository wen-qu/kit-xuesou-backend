# git-diff-index
# Autogenerated from man page /usr/share/man/man1/git-diff-index.1
...
complete -c git-diff-index -o 'I<regex>' -l ignore-matching-lines --description 'Ignore changes whose all lines match <regex>.'
...
complete -c git-diff-index -s W -l function-context --description 'Show whole function as context lines for each change.'
...
complete -c git-diff-index -l merge-base --description 'Instead of comparing <tree-ish> directly, use the merge base between <tree-is…'
