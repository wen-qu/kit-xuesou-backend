# git-ls-files
# Autogenerated from man page /usr/share/man/man1/git-ls-files.1
...
complete -c git-ls-files -l abbrev --description 'Instead of showing the full 40-byte hexadecimal object lines, show the shorte…'
