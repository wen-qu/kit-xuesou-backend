# git-am
# Autogenerated from man page /usr/share/man/man1/git-am.1
complete -c git-am -s s -l signoff --description 'Add a Signed-off-by trailer to the commit message, using the committer identi…'
