# git-blame
# Autogenerated from man page /usr/share/man/man1/git-blame.1
...
complete -c git-blame -s L -s L --description 'Annotate only the line range given by <start>,<end>, or by the function name …'
...
complete -c git-blame -l first-parent --description 'Follow only the first parent commit upon seeing a merge commit.'
