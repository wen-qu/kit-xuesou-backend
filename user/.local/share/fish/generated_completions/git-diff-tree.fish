# git-diff-tree
# Autogenerated from man page /usr/share/man/man1/git-diff-tree.1
...
complete -c git-diff-tree -o 'I<regex>' -l ignore-matching-lines --description 'Ignore changes whose all lines match <regex>.'
...
complete -c git-diff-tree -s W -l function-context --description 'Show whole function as context lines for each change.'
...
complete -c git-diff-tree -l merge-base --description 'Instead of comparing the <tree-ish>s directly, use the merge base between the…'
...
complete -c git-diff-tree -l abbrev-commit --description 'Instead of showing the full 40-byte hexadecimal commit object name, show a pr…'
