# git-rev-parse
# Autogenerated from man page /usr/share/man/man1/git-rev-parse.1
...
complete -c git-rev-parse -l show-toplevel --description 'Show the absolute path of the top-level directory of the working tree.'
...
complete -c git-rev-parse -l end-of-options --description 'so that the name argument is not mistaken for another option.'
