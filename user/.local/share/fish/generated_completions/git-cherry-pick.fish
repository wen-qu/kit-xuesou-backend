# git-cherry-pick
# Autogenerated from man page /usr/share/man/man1/git-cherry-pick.1
...
complete -c git-cherry-pick -s s -l signoff --description 'Add a Signed-off-by trailer at the end of the commit message.'
