...
complete -c git-svn -s m -l merge -o 's<strategy>' -l strategy -s p -l rebase-merges -l preserve-merges --description 'These are only used with the dcommit and rebase commands.'
